...
import { Trash2, Heart, Plus, Minus, ChevronLeft, ShieldCheck, Truck, RotateCcw } from "lucide-react";
      ...
      <main className="pt-24 pb-20 px-4 md:px-8 lg:px-16 max-w-[1400px] mx-auto">
        <div className="mb-10 mt-4">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-secondary text-sm mt-1 font-medium">{cartItems.length} articles au total</p>
          </div>
        </div>
                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between mt-6 gap-5">
                    <div className="flex items-center border border-black/10 rounded-full px-5 py-2 space-x-6">
                      <button className="hover:opacity-50 transition-opacity"><Minus className="w-3 h-3" /></button>
                      <span className="font-bold text-base">{item.quantity}</span>
                      <button className="hover:opacity-50 transition-opacity"><Plus className="w-3 h-3" /></button>
                    </div>
            ...
            <div className="bg-white border border-black/5 p-6 rounded-[1.5rem] shadow-sm">
              ...
              <div className="space-y-4 text-sm font-bold">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-green-600 uppercase text-[10px]">Gratuit</span>
                </div>
                <div className="flex justify-between items-center">
